...
public class ChooseReward extends Gui {
    ...
    private final GenericLabel label = (GenericLabel) new GenericLabel().setText("Choose Reward").setHeight(15).shiftXPos(-15).setAnchor(WidgetAnchor.TOP_CENTER);
    ...
    protected void createPopup(boolean attach, boolean remove) {
        ...
        popup.attachWidget(
                plugin,
                new GenericButton("Material").setWidth(200).setHeight(20).shiftXPos(-100).setY(Y).setAnchor(WidgetAnchor.TOP_CENTER));
        popup.attachWidget(
                plugin,
                new GenericButton("Money").setWidth(200).setHeight(20).shiftXPos(-100).setY(Y + 25).setAnchor(WidgetAnchor.TOP_CENTER));
        popup.attachWidget(
                plugin,
                new GenericButton("Xp").setWidth(200).setHeight(20).shiftXPos(-100).setY(Y + 50).setAnchor(WidgetAnchor.TOP_CENTER));
