...
public class SmeltTask extends Task {
    ...
    public SmeltTask(int id, Material material, int amount, String taskGiver,
            String taskEnder) {
    ...
    public SmeltTask(int id, Material material, int amount, short durability,
    ...
    public SmeltTask(int id, ItemStack material, String taskGiver,
            String taskEnder) {
        super(id, TaskType.SMELT, taskGiver, taskEnder);
