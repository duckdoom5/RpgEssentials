...
public class RpgServer extends JavaPlugin {
    ...
    private final RpgServerCommandExecutor command = new RpgServerCommandExecutor(
            this);
    ...
    public void onEnable() {
        ...
        final PhpSendPlugin pl = new PHPsend();
    ...
    protected void logmsg(boolean enable) {
        ...
        if (enable) {
            RpgServer.log.info("version: " + pdfile.getVersion() + " is now enabled !");
        } else {
            RpgServer.log.info("is now disabled !");
        }
