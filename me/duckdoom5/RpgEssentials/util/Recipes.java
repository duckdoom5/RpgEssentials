...
public class Recipes {
	...
	public static void checkitem(String type, GenericItem item){
		for(int rpc = 1; rpc < 10; ++rpc){
			if(itemconfig.contains("Custom " + type + "." + item.getName() + ".shaped recipe"+ rpc)){
						...
						for(i = 0; i<3;){
							...
							if(row1[i] != "-"){
								try{
									if(i == 0){
										if(row1dv1 != null){
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row1[i]), Short.parseShort(row1dv1[1])));
										...
										if(row1dv2 != null){
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row1[i]), Short.parseShort(row1dv2[1])));
											srow1 = srow1 + rowletter;
										}else{
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row1[i])));
											srow1 = srow1 + rowletter;
										...
										if(row1dv3 != null){
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row1[i]), Short.parseShort(row1dv3[1])));
											srow1 = srow1 + rowletter;
										}else{
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row1[i])));
											srow1 = srow1 + rowletter;
						...
						for(int i = 0; i<3;){
							...
							if(row2[i] != "-"){
								try{
									if(i == 0){
										if(row2dv1 != null){
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row2[i]), Short.parseShort(row2dv1[1])));
										...
										if(row2dv2 != null){
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row2[i]), Short.parseShort(row2dv2[1])));
											srow2 = srow2 + rowletter;
										}else{
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row2[i])));
											srow2 = srow2 + rowletter;
										...
										if(row2dv3 != null){
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row2[i]), Short.parseShort(row2dv3[1])));
											srow2 = srow2 + rowletter;
										}else{
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row2[i])));
											srow2 = srow2 + rowletter;
						...
						for(int i = 0; i<3;){
							...
							if(row3[i] != "-"){
								try{
									if(i == 0){
										if(row3dv1 != null){
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row3[i]), Short.parseShort(row3dv1[1])));
										...
										if(row3dv2 != null){
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row3[i]), Short.parseShort(row3dv2[1])));
											srow3 = srow3 + rowletter;
										}else{
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row3[i])));
											srow3 = srow3 + rowletter;
										...
										if(row3dv3 != null){
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row3[i]), Short.parseShort(row3dv3[1])));
											srow3 = srow3 + rowletter;
										}else{
											recipe.setIngredient(letter, MaterialData.getMaterial(Integer.parseInt(row3[i])));
											srow3 = srow3 + rowletter;
				...
				System.out.println("[RpgEssentials] Added recipe for: " + item.getName());
	...
	public static void checkblock(String type, CustomOresDesign item){
		for(int rpc = 1; rpc < 10; ++rpc){
			if(itemconfig.contains("Custom " + type + "." + item.getName() + ".shaped recipe"+ rpc)){
				int amount = itemconfig.getInt("Custom " + type + "." + item.getName() + ".shaped recipe"+ rpc +".amount");
				List list = itemconfig.getList("Custom " + type + "." + item.getName() + ".shaped recipe"+ rpc +".ingredients");
