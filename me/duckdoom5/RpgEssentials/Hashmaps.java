...
import me.duckdoom5.RpgEssentials.blocks.plants.MicrowaveBlock;
...
public class Hashmaps {
	...
	public static Set<CustomOresDesign> customores = new HashSet<CustomOresDesign>();
	public static Set<GenericCustomItem> customitems = new HashSet<GenericCustomItem>();
	public static Set<GenericCustomTool> customtools = new HashSet<GenericCustomTool>();
	public static Set<OriginalOresDesign> originalores = new HashSet<OriginalOresDesign>();
	public static Set<GenericCubeCustomBlock> bushes = new HashSet<GenericCubeCustomBlock>();
	public static Set<GenericCubeCustomBlock> stairs = new HashSet<GenericCubeCustomBlock>();
	public static Set<GenericCubeCustomBlock> plants = new HashSet<GenericCubeCustomBlock>();
	...
	public static void CustomOres(RpgEssentials plugin){
		...
		for(int i = 0; keys.hasNext(); ++i){
			...
			addOre(plugin, name, textureID, freq, minY, maxY);
		}
	}
