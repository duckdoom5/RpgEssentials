...
public class StoreHashmaps {
	...
	public static void registerstore(RpgEssentials plugin){
		...
		if(Configuration.store.getBoolean("Store.Mechanisms.redstone lamp off.Sell Able") == true){
			mechanisms.add(Material.REDSTONE_LAMP_OFF);
		}
		...
		//custom items
		for (GenericCustomItem items:Hashmaps.customitems) {
			if(Configuration.store.getBoolean("Store.custom.Items." + items.getName() + ".Sell Able") == true){
				customitems.add(items);
			}
		}
		
		//custom tools
		for (GenericCustomTool tools:Hashmaps.customtools) {
			if(Configuration.store.getBoolean("Store.custom.Tools." + tools.getName() + ".Sell Able") == true){
		...
		for (GenericCustomFood food:Hashmaps.customfood) {
			if(Configuration.store.getBoolean("Store.custom.Food." + food.getName() + ".Sell Able") == true){
				customfood.add(food);
			}
		}
