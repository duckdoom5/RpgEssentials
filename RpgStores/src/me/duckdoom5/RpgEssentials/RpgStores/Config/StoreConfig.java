...
public class StoreConfig {
    public static HashMap<String, String> custommaterials = new LinkedHashMap<>();
    ...
    public static void set() {
        ...
        // custom materials
        update();
        for (final String name : custommaterials.keySet()) {
            ...
            if (!Configuration.store.contains("Store.custom." + custommaterials.get(name) + "." + name + ".Buy Price")) {
                Configuration.store.set("Store.custom." + custommaterials.get(name) + "." + name + ".Buy Price",
                        config.getInt("Custom " + custommaterials.get(name) + "." + name + ".Buy Price"));
            }
            if (!Configuration.store.contains("Store.custom." + custommaterials.get(name) + "." + name + ".Sell Price")) {
                Configuration.store.set("Store.custom." + custommaterials.get(name) + "." + name + ".Sell Price",
                        config.getInt("Custom " + custommaterials.get(name) + "." + name + ".Sell Price"));
            }
        }
    }

    private static void update() {
        final String[] types = new String[] { "Items", "Tools", "Food", "Fish", "Ores", "Blocks" };
    ...
    public static enum StoreValue {
        ...
        PUMPKIN_PIE("Food", null, null, true, true, 60, 30),
        ...
        BAKED_POTATO("Food", null, null, true, true, 20, 10),
        POISONOUS_POTATO("Food", null, null, true, true, 10, 5),
        POTATO_ITEM("Food", null, null, true, true, 15, 5),
        CARROT_ITEM("Food", null, null, true, true, 20, 10),
        GOLDEN_CARROT("Food", null, null, true, true, 20, 10),
        ...
        MINECART("Tools", "Mechanisms", null, true, true, 100, 50),
        HOPPER_MINECART("Tools", "Mechanisms", null, true, true, 150, 75), 
        EXPLOSIVE_MINECART("Tools", "Mechanisms", null, true, true, 150, 75),
        POWERED_MINECART("Tools", "Mechanisms", null, true, true, 150, 75),
        STORAGE_MINECART("Tools", "Mechanisms", null, true, true, 150, 75),
        ...
        EMPTY_MAP("Tools", null, null, true, true, 300, 100),
        BOOK_AND_QUILL("Tools", null, null, true, true, 70, 35),
        CARROT_STICK("Tools", null, null, true, true, 70, 35),
        ...
        IRON_BARDING("Armor", "Miscellaneous", null, true, true, 500, 250),
        ...
        GOLD_BARDING("Armor", "Miscellaneous", null, true, true, 500, 250), 
        ...
        DIAMOND_BARDING("Armor", "Miscellaneous", null, true, true, 500, 250),

        ACTIVATOR_RAIL("Mechanisms", null, null, true, true, 60, 30),
        ...
        DAYLIGHT_DETECTOR("Mechanisms", null, null, true, true, 100, 50),
        DROPPER("Mechanisms", null, null, true, true, 100, 50),
        HOPPER("Mechanisms", null, null, true, true, 100, 50),
        REDSTONE_COMPARATOR("Mechanisms", null, null, true, true, 100, 50),
        REDSTONE_BLOCK("Mechanisms", null, null, true, true, 45, 9),
        ...
        FLOWER_POT_ITEM("Gardening", null, null, true, true, 30, 5),

        BED("Furniture", null, null, true, true, 250, 50),
        BOOKSHELF("Furniture", null, null, true, true, 150, 75),
        HAY_BLOCK("Furniture", null, null, true, true, 75, 35),
        ...
        QUARTZ_STAIRS("Furniture", null, null, true, true, 80, 40),
        ...
        ANVIL("Furniture", null, null, true, true, 40, 5),
        BEACON("Furniture", null, null, true, true, 40, 5),
        ITEM_FRAME("Furniture", null, null, true, true, 40, 5),
        COMMAND("Furniture", "Mechanisms", null, false, false, 1000000, 1),
        ...
        CLAY("Materials", null, null, true, true, 20, 5),
        HARD_CLAY("Materials", "Furniture", null, true, true, 25, 6),
        STAINED_CLAY("Materials", "Furniture", null, true, true, 220, 75),
        SMOOTH_BRICK("Materials", null, null, true, true, 110, 20),
        MYCEL("Materials", null, null, true, true, 150, 10),
        QUARTZ_BLOCK("Materials", null, null, true, true, 240, 20),
        ...
        CLAY_BALL("Raw Materials", null, null, true, true, 5, 3),
        ...
        COAL_BLOCK("Raw Materials", null, null, true, true, 1125, 100),
        ...
        QUARTZ("Raw Materials", null, null, true, true, 60, 5),
        ...
        QUARTZ_ORE("Ores", null, null, true, true, 250, 30),
        ...
        WOOL("Painting", "Furniture", null, true, true, 25, 5),
        INK_SACK("Painting", null, null, true, true, 30, 5),
        CARPET("Painting", "Furniture", null, true, true, 70, 35),

        NETHERRACK("Nether", "Materials", null, true, true, 50, 5),
        NETHER_BRICK("Nether", "Raw Materials", null, true, true, 60, 10),
        ...
        NETHER_STAR("Nether", "Miscellaneous", null, true, true, 5000, 300),
        ...
        NAME_TAG("Miscellaneous", null, null, true, true, 500, 10),
        LEASH("Miscellaneous", null, null, true, true, 200, 10),
        WEB("Miscellaneous", null, null, true, true, 80, 10),
        FIREWORK_CHARGE("Miscellaneous", null, null, true, true, 80, 10),
        FIRE("Miscellaneous", null, null, false, false, 60, 10),
        EXP_BOTTLE("Miscellaneous", null, null, false, false, 5000, 10),
        SKULL_ITEM("Miscellaneous", null, null, true, true, 2000, 50),
