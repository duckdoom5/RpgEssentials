...
public class PlantsPopulator extends BlockPopulator {
    ...
    private final BlockFace[] faces = { BlockFace.NORTH, BlockFace.SOUTH,
    ...
    public void populate(World world, Random random, Chunk chunk) {
        ...
        // grass
        if (Configuration.generator.getBoolean("Global.grass.generate")) {
            final int grass = Configuration.generator.getInt("Global.grass.frequency");
                ...
                if (biome.equals(Biome.DESERT) || biome.equals(Biome.DESERT_HILLS)) {
                    if (random.nextInt(100) < 20) {
                        if (material.equals(Material.SAND)) {
                            block.getRelative(0, 1, 0).setType(
                                    Material.DEAD_BUSH);
            ...
            if (grasslogged == false) {
                RpgEssentials.getLog().info("Grass generation disabled");
                grasslogged = true;
            }
        }

        // flowers
        if (Configuration.generator.getBoolean("Global.flowers.generate") == true) {
            final int flower = Configuration.generator.getInt("Global.flowers.frequency");
            for (int i = 0; i < flower; i++) {
                flowertype = (random.nextInt(100) < 40) ? Material.RED_ROSE
            ...
            if (flowerlogged == false) {
                RpgEssentials.getLog().info("Flower generation disabled");
                flowerlogged = true;
            }
        }

        // cacti
        if (Configuration.generator.getBoolean("Global.cacti.generate") == true) {
            final int cacti = Configuration.generator.getInt("Global.cacti.frequency");
                    ...
                    if (biome.equals(Biome.DESERT)) {
                        if (material.equals(Material.SAND)) {
                            ...
                            if (air == 4) {
                                block.getRelative(0, 1, 0).setType(
                                        Material.CACTUS);
                                block.getRelative(0, 2, 0).setType(
                                        Material.CACTUS);
                                if (random.nextInt(100) < 60) {
                                    block.getRelative(0, 3, 0).setType(
                                            Material.CACTUS);
                                }
                            }
                        }
            ...
            if (cactilogged == false) {
                RpgEssentials.getLog().info("Cacti generation disabled");
                cactilogged = true;
            }
        }
        // pumpkin and melon farm
        if (Configuration.generator.getBoolean("Global.pumpkins and melons.generate") == true) {
            final int mandp = Configuration.generator.getInt("Global.pumpkins and melons.frequency");
            for (int i = 0; i < mandp; i++) {
                type = (random.nextInt(100) < 40) ? Material.MELON_BLOCK
                        : Material.PUMPKIN;
            ...
            if (pandmlogged == false) {
                RpgEssentials.getLog().info("Pumpkins and melon generation disabled");
                pandmlogged = true;
            }
        }
        // reeds
        if (Configuration.generator.getBoolean("Global.sugar cane.generate") == true) {
            final int sugar = Configuration.generator.getInt("Global.sugar cane.frequency");
            ...
            if (canelogged == false) {
                RpgEssentials.getLog().info("Sugar cane generation disabled");
                canelogged = true;
            }
        }

        // trees
        if (Configuration.generator.getBoolean("Global.trees.generate") == true) {
            final int tree = Configuration.generator.getInt("Global.trees.frequency");
            for (int i = 0; i < tree; i++) {
                if (material.equals(Material.GRASS)) {
                    treetype = (random.nextInt(100) < 1) ? TreeType.BIG_TREE
                            : (random.nextInt(100) < 2) ? TreeType.BIRCH
                                    : TreeType.TREE;
                    redwood = (random.nextInt(100) < 5) ? TreeType.TALL_REDWOOD
                            : TreeType.REDWOOD;
                    mushroom = (random.nextInt(100) < 40) ? TreeType.RED_MUSHROOM
                            : TreeType.BROWN_MUSHROOM;
                    jungletype = (random.nextInt(100) < 70) ? TreeType.JUNGLE_BUSH
                            : (random.nextInt(100) < 60) ? TreeType.JUNGLE
            ...
            if (treelogged == false) {
                RpgEssentials.getLog().info("Tree generation disabled");
                treelogged = true;
            }
        }
        // mushrooms

        mushroomtype = (random.nextInt(100) < 40) ? Material.RED_MUSHROOM
                : Material.BROWN_MUSHROOM;
        if (Configuration.generator.getBoolean("Global.mushrooms.generate") && Configuration.generator.getBoolean("Generator.trees.generate")) {
            final int mushrooms = Configuration.generator.getInt("Global.mushrooms.frequency");
            ...
            if (mushlogged == false) {
                RpgEssentials.getLog().info("Mushroom generation disabled");
                mushlogged = true;
            }
        }
    }

    private void makefarm(Block block, Chunk chunk, int x, int y, int z,
            Material material) {
