...
public abstract class Commandold {
    ...
    private final String[] requiredArgs, optionalArgs;
    private final boolean requirePermissions, consoleCanExecute, npcCommand;
    ...
    public void notEnoughArgs(CommandSender sender) {
        ...
        for (final String s : requiredArgs) {
            msg += ChatColor.RED + "{" + s + "}";
        }
        for (final String s : optionalArgs) {
