...
public final class AnvilDesign extends GenericBlockDesign {
    public AnvilDesign(RpgEssentials plugin, Texture texture) {
        ...
        final Quad base = new Quad(0, subTex);
        ...
        final Quad fFront = new Quad(5, subTex);
        ...
        final Quad fLeft = new Quad(6, subTex);
        ...
        final Quad fTop = new Quad(7, subTex);
        ...
        final Quad fRight = new Quad(8, subTex);
        ...
        final Quad TopBase = new Quad(9, subTex);
        ...
        final Quad TopSide = new Quad(10, subTex);
        ...
        final Quad TopLeft = new Quad(11, subTex);
        ...
        final Quad TopRight = new Quad(12, subTex);
        ...
        final Quad TopTip = new Quad(13, subTex);
        ...
        final Quad TopTipVert = new Quad(14, subTex);
        ...
        final Quad TopUnderSide = new Quad(15, subTex);
        ...
        final Quad TopLeftX = new Quad(16, subTex);
        ...
        final Quad TopRightX = new Quad(17, subTex);
