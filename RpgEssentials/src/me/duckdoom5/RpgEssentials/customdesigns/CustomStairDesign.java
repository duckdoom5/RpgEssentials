...
public class CustomStairDesign extends GenericBlockDesign {
    ...
    public CustomStairDesign(RpgEssentials plugin, int[] textureids) {
        ...
        final Quad front = new Quad(1, texture.getSubTexture(textureids[0]));
        ...
        fronttop.addVertex(3, 0.0F, 0.0F, 0.5F);
        fronttop.addVertex(2, 0.0F, 1.0F, 0.5F);
        fronttop.addVertex(1, 1.0F, 1.0F, 0.5F);
        fronttop.addVertex(0, 1.0F, 0.0F, 0.5F);

        final Quad back = new Quad(3, texture.getSubTexture(textureids[0]));
        ...
        final Quad left = new Quad(4, texture.getSubTexture(textureids[0]));
        ...
        final Quad lefttop = new Quad(5, texture.getSubTexture(textureids[0]));
        lefttop.addVertex(0, 1.0F, 0.5F, 0.0F);
        lefttop.addVertex(1, 1.0F, 1.0F, 0.0F);
        lefttop.addVertex(2, 1.0F, 1.0F, 0.5F);
        lefttop.addVertex(3, 1.0F, 0.5F, 0.5F);

        final Quad right = new Quad(6, texture.getSubTexture(textureids[0]));
        ...
        final Quad righttop = new Quad(7, texture.getSubTexture(textureids[0]));
        righttop.addVertex(3, 0.0F, 0.5F, 0.0F);
        righttop.addVertex(2, 0.0F, 1.0F, 0.0F);
        righttop.addVertex(1, 0.0F, 1.0F, 0.5F);
        righttop.addVertex(0, 0.0F, 0.5F, 0.5F);

        final Quad top1 = new Quad(8, texture.getSubTexture(textureids[0]));
        ...
        final Quad top2 = new Quad(9, texture.getSubTexture(textureids[0]));
        top2.addVertex(2, 0.0F, 1.0F, 0.0F);
        top2.addVertex(1, 1.0F, 1.0F, 0.0F);
        top2.addVertex(0, 1.0F, 1.0F, 0.5F);
        top2.addVertex(3, 0.0F, 1.0F, 0.5F);
