...
public class CustomBushDesign extends GenericBlockDesign {
    ...
    public CustomBushDesign(RpgEssentials plugin, int[] textureids) {
        ...
        final Quad fronttop = new Quad(2, texture.getSubTexture(textureids[0]));
        ...
        final Quad frontbottom = new Quad(3,
                texture.getSubTexture(textureids[0]));
        ...
        final Quad back = new Quad(4, texture.getSubTexture(textureids[2]));
        ...
        final Quad backtop = new Quad(5, texture.getSubTexture(textureids[0]));
        ...
        final Quad backbottom = new Quad(6,
                texture.getSubTexture(textureids[0]));
        ...
        final Quad left = new Quad(7, texture.getSubTexture(textureids[3]));
        ...
        final Quad lefttop = new Quad(8, texture.getSubTexture(textureids[0]));
        ...
        final Quad leftbottom = new Quad(9,
                texture.getSubTexture(textureids[0]));
        ...
        final Quad right = new Quad(10, texture.getSubTexture(textureids[0]));
        ...
        final Quad righttop = new Quad(11, texture.getSubTexture(textureids[0]));
        ...
        final Quad rightbottom = new Quad(12,
                texture.getSubTexture(textureids[0]));
        ...
        final Quad top = new Quad(13, texture.getSubTexture(textureids[0]));
        ...
        final Quad side1 = new Quad(14, texture.getSubTexture(textureids[0]));
        ...
        final Quad side2 = new Quad(15, texture.getSubTexture(textureids[0]));
        ...
        final Quad side3 = new Quad(16, texture.getSubTexture(textureids[0]));
        ...
        final Quad side4 = new Quad(17, texture.getSubTexture(textureids[0]));
        ...
        final Quad top1 = new Quad(18, texture.getSubTexture(textureids[0]));
        ...
        final Quad top2 = new Quad(19, texture.getSubTexture(textureids[0]));
        ...
        final Quad top3 = new Quad(20, texture.getSubTexture(textureids[0]));
        ...
        final Quad top4 = new Quad(21, texture.getSubTexture(textureids[0]));
        ...
        final Quad bottom1 = new Quad(22, texture.getSubTexture(textureids[0]));
        ...
        final Quad bottom2 = new Quad(23, texture.getSubTexture(textureids[0]));
        ...
        final Quad bottom3 = new Quad(24, texture.getSubTexture(textureids[0]));
        ...
        final Quad bottom4 = new Quad(25, texture.getSubTexture(textureids[0]));
