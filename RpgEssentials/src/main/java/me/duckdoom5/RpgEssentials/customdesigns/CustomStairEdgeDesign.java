...
public class CustomStairEdgeDesign extends GenericBlockDesign {
	...
	public CustomStairEdgeDesign(RpgEssentials plugin, int[] textureids) {
		...
		Quad fronttop = new Quad(2, texture.getSubTexture(textureids[2]));
		...
		Quad back = new Quad(3, texture.getSubTexture(textureids[1]));
		...
		Quad backtop = new Quad(4, texture.getSubTexture(textureids[2]));
		...
		Quad left = new Quad(5, texture.getSubTexture(textureids[1]));
		...
		Quad lefttop = new Quad(6, texture.getSubTexture(textureids[2]));
		...
		Quad right = new Quad(7, texture.getSubTexture(textureids[1]));
		...
		Quad righttop = new Quad(8, texture.getSubTexture(textureids[2]));
		...
		Quad top2 = new Quad(10, texture.getSubTexture(textureids[2]));
