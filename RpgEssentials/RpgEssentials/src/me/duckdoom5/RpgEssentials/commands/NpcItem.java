				...
				if(plugin.hasPermission(player, "rpgessentials.npc.item") || plugin.hasPermission(player, "rpgessentials.npc.admin")){
					...
					if(id != null){
						...
						try {
							...
							if(RpgEssentials.mm.hasMaterial(args[1])){
								org.getspout.spoutapi.material.Material smaterial = RpgEssentials.mm.getMaterialByName(args[1]);
							...
							Configuration.npc.set("Npc." + id + ".item data", customId);
							humannpc.setItemInHand(material, (short) customId);
