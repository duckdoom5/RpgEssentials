...
public class Editor implements Gui{
	...
	public Editor(RpgQuests plugin, SpoutPlayer splayer){
		this.plugin = plugin;
	...
	private void createPopup(Boolean attach) {
		...
		popup.attachWidget(plugin, new GenericButton("Edit Task").setWidth(200).setHeight(20).shiftXPos(-100).setY(Y + 25).setAnchor(WidgetAnchor.TOP_CENTER));
		
		popup.attachWidget(plugin, new GenericButton("Edit Reward").setWidth(200).setHeight(20).shiftXPos(-100).setY(Y + 50).setAnchor(WidgetAnchor.TOP_CENTER));
		
		popup.attachWidget(plugin, new GenericButton("Edit Settings").setWidth(200).setHeight(20).shiftXPos(-100).setY(-Y - 25).setAnchor(WidgetAnchor.BOTTOM_CENTER));
