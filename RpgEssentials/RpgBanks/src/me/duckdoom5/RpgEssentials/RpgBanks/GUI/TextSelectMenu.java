package me.duckdoom5.RpgEssentials.RpgBanks.GUI;
...
public class TextSelectMenu implements Gui{
	...
	public TextSelectMenu(RpgBanks plugin, SpoutPlayer splayer, String title, String[] text, String[] buttons, EntityType toTalkTo){
		this.plugin = plugin;
